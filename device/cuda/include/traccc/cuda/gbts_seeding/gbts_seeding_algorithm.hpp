...
class gbts_seeding_algorithm : public algorithm<edm::seed_collection::buffer(
    ...
    gbts_seeding_algorithm(
        const gbts_seedfinder_config& finder_config,
		traccc::memory_resource& mr, vecmem::copy& copy, stream& str
    ...
    output_type operator()(const edm::spacepoint_collection::const_view&
                               spacepoints, const edm::measurment_collection::const_view&) const override;
	...
	//The CUDA stream
	std::refrence_wrapper<stream> m_stream;	
